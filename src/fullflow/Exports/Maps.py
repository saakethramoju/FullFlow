...
class Axis:
    ...
    units:
        ...
        FullFlow does not perform unit conversion.
    spacing:
...
def generate_map(
    ...
    The generated file can be loaded by ``Map.from_hdf5`` and used as a normal
    FullFlow component. ``generate_map`` evaluates a Python function on every
