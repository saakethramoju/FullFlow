...
class FlowMixer(Component):
    ...
    def __init__(
        ...
        composition_in1: Composition | None = None,
        composition_in2: Composition | None = None,
...
class FlowSplitter(Component):
    ...
    def __init__(
        ...
        if self._solve_species:
            ...
            if not isinstance(self.composition_out2, Composition):
                self.composition_out2 = Composition()
            ...
            if not isinstance(self.composition_out1, Composition):
                self.composition_out1 = Composition()
